      ...
      <Section>
          ...
          >
            <div>
              <p className="small">
                ...
                your CO₂e emissions, then helps you offset it with a
                reforestation program.
              </p>
              <p className="small">
                You can use it to calculate your carbon footprint, offset with a
                simple monthly subscription and follow your friends to track
                their impact.
              </p>
            </div>
            <div>
              ...
              <p className="small">
                So far, we’ve helped our users plant 1297 trees and offset
                162.13 tonnes of CO₂e across 31 programs.
              </p>
        ...
        <Fade triggerOnce>
          ...
          >
            ...
            <div>
              <p className="small">
                It’s still very much in progress but you can follow along with
                my newest designs on Dribbble.
              </p>
            </div>
          </Project>
        </Fade>
          ...
          >
            <div>
              ...
              <p className="small">
                ...
                candidates get their dream job. Before pivoting to B2B, we
                helped 2000+ candidates secure jobs.
              </p>
            </div>
            <div>
              <p className="small">
                After pivoting, I ended up licensing the platform to SEEK
                (Australia’s no. 1 jobs, employment, career and recruitment
                site) in Hong Kong for a while, where we managed 100K+ job
                applications and analysed 1M+ data points.
              </p>
              <p className="small">
